...
app_group: gp279
name: commission
dev_owner: Jizong.Li,Yu.Tang
aliases: [gp279_commission]
related_services: []
related_tables: []
---
...
> 来源:UAT Kibana trace, last 120d 宽窗口采样(2026-06-24) + 作用说明。候选待人审。app_group=`gp279` · domain=`payment-core`。
...
## 来源与置信
- UAT Kibana trace, last 120d 宽窗口采样(2026-06-24) + 作用说明。候选待人审。app_group=`gp279` · domain=`payment-core`。
