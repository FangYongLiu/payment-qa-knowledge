...
## 关键方法 / 入口
**UAT Kibana 7d INFO 观测的主要业务类**(app_id=`wechat-channel`,=实际在跑的业务操作 / 入口):
- `QueryTransactionRequester`×839,315 — 微信交易查询
- `DefaultRemChannelFacadeImpl`×562,408 — 汇/渠道门面
- `WeChantUesClientImpl`×281,288 — 微信 UES
- `AcsClientImpl`×1,124,976 — 调 ACS
