---
id: tbl_dpm_t_dpm_inner_account_diary
object_type: Table
domain: payment-core
status: active
owner: xiaoyan.zhou
...
- dpm
- dpm
- t_dpm_inner_account_diary
subdomain: dpm
module: null
sensitivity: normal
name: 内部账户日记账(t_dpm_inner_account_diary)
aliases:
- t_dpm_inner_account_diary
related_services:
- svc_dpm_accounting
related_scenarios: []
---
# 内部账户日记账(t_dpm_inner_account_diary)

## 用途
内部账户日记账。属 dpm 库,由 [[svc_dpm_accounting]] 读写。
