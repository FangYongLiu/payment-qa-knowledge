---
id: tbl_member_tm_password_blacklist
object_type: Table
domain: payment-core
status: active
owner: xiaoyan.zhou
...
# Password blacklist(tm_password_blacklist)

## 用途
Password blacklist。属 member 库,由 [[svc_member]] 读写。
...
| `enable_flag` | char | NOT NULL / 默认 'Y' | Enable flag |
