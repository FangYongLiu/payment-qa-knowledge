---
id: tbl_household_t_hh_official_item
object_type: Table
name: household item (t_hh_official_item)
aliases: [t_hh_official_item, household.t_hh_official_item]
...
# household item (t_hh_official_item)

## 用途
物理表 `household.t_hh_official_item`,主键 `id`。household item。业务语义细节**待补**(表结构来自 DDL)。
...
| `type` | char(10) | enum:Transfer|Notify |
