---
id: tbl_household_t_compensation_event
object_type: Table
name: Compensation Event (t_compensation_event)
aliases: [t_compensation_event, household.t_compensation_event]
...
## 用途
物理表 `household.t_compensation_event`,主键 `event_id`。Compensation Event。业务语义细节**待补**(表结构来自 DDL)。
