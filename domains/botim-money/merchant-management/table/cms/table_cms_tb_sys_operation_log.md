---
id: tbl_cms_tb_sys_operation_log
object_type: Table
name: 操作日志 (tb_sys_operation_log)
aliases: [tb_sys_operation_log, cms.tb_sys_operation_log]
...
## 用途
物理表 `cms.tb_sys_operation_log`,主键 `operation_log_id`。操作日志。业务语义细节**待补**(表结构来自 DDL)。
