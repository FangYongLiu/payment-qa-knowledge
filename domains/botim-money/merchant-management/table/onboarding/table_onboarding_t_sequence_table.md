---
id: tbl_onboarding_t_sequence_table
object_type: Table
name: sequence_table (t_sequence_table)
aliases: [t_sequence_table, onboarding.t_sequence_table]
...
## 用途
物理表 `onboarding.t_sequence_table`,主键 `sequence_name`。sequence_table。业务语义细节**待补**(表结构来自 DDL)。
