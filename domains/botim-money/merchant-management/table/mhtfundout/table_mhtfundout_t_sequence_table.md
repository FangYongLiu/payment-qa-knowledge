---
id: tbl_mhtfundout_t_sequence_table
object_type: Table
name: 序号生成表 (t_sequence_table)
aliases: [t_sequence_table, mhtfundout.t_sequence_table]
...
## 用途
物理表 `mhtfundout.t_sequence_table`,主键 `sequence_name`。序号生成表。业务语义细节**待补**(表结构来自 DDL)。
