---
id: tbl_basis_tb_uq_data_source
object_type: Table
name: 数据源定义 (tb_uq_data_source)
aliases: [tb_uq_data_source, basis.tb_uq_data_source]
...
## 用途
物理表 `basis.tb_uq_data_source`,主键 `source_id`。数据源定义。业务语义细节**待补**(表结构来自 DDL)。
