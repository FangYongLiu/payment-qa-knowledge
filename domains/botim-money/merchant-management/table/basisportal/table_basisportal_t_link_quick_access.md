---
id: tbl_basisportal_t_link_quick_access
object_type: Table
name: quick access link table (t_link_quick_access)
aliases: [t_link_quick_access, basisportal.t_link_quick_access]
...
# quick access link table (t_link_quick_access)

## 用途
物理表 `basisportal.t_link_quick_access`,主键 `id`。quick access link table。业务语义细节**待补**(表结构来自 DDL)。
