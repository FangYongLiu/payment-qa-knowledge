---
id: tbl_basismcht_tb_sys_menu
object_type: Table
name: 菜单表 (tb_sys_menu)
aliases: [tb_sys_menu, basismcht.tb_sys_menu]
...
## 用途
物理表 `basismcht.tb_sys_menu`,主键 `menu_id`。菜单表。业务语义细节**待补**(表结构来自 DDL)。
...
| `is_sensitive` | varchar(32) | 是否敏感 Y:是 N:否 · 可空 |
