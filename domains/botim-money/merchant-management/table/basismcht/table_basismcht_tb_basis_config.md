---
id: tbl_basismcht_tb_basis_config
object_type: Table
name: basis综合配置表 (tb_basis_config)
aliases: [tb_basis_config, basismcht.tb_basis_config]
...
## 用途
物理表 `basismcht.tb_basis_config`,主键 `config_id`。basis综合配置表。业务语义细节**待补**(表结构来自 DDL)。
