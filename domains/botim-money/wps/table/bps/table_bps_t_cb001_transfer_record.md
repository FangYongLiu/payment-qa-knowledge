---
id: tbl_bps_t_cb001_transfer_record
object_type: Table
name: cb001 transfer record (t_cb001_transfer_record)
aliases: [t_cb001_transfer_record, bps.t_cb001_transfer_record]
domain: wps
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
# cb001 transfer record (t_cb001_transfer_record)

## 用途
物理表 `bps.t_cb001_transfer_record`,主键 `id`。cb001 transfer record。业务语义细节**待补**(表结构来自 DDL)。
...
| `send_email` | char | send email flag · 可空 |
