---
id: tbl_amlreport_tb_profile_device_report
object_type: Table
name: 设备画像数据统计 (tb_profile_device_report)
aliases: [tb_profile_device_report, amlreport.tb_profile_device_report]
domain: compliance
status: active
owner: dewen.li
reviewer: dewen.li
...
# 设备画像数据统计 (tb_profile_device_report)

## 用途
物理表 `amlreport.tb_profile_device_report`,主键 `id`。设备画像数据统计。业务语义细节**待补**(表结构来自 DDL)。
