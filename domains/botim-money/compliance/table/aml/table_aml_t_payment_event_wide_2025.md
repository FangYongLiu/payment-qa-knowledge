...
tags:
- aml
- t_payment_event_wide_2025
subdomain: aml
module: null
sensitivity: normal
name: 支付事件宽表(2025) (t_payment_event_wide_2025)
aliases:
- t_payment_event_wide_2025
- aml.t_payment_event_wide_2025
related_services: []
---

# 支付事件宽表(2025) (t_payment_event_wide_2025)

## 用途
物理表 `aml.t_payment_event_wide_2025`,主键 `id`。Payment event wide table。属 AML/合规库 `aml`。业务语义细节**待补**(表结构来自 DDL)。
