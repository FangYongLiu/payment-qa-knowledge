---
id: tbl_preauth_t_void_ops_order
object_type: Table
name: salevoid订单 (t_void_ops_order)
aliases: [t_void_ops_order, preauth.t_void_ops_order]
...
# salevoid订单 (t_void_ops_order)

## 用途
物理表 `preauth.t_void_ops_order`,主键 `global_id`。salevoid订单。业务语义细节**待补**(表结构来自 DDL)。
...
## 主键 / 索引
- 主键:`global_id`
- `i_voo_ct`:created_time
- `i_voo_lut`:last_updated_time
- `i_voo_ogi`:origin_global_id
- `i_voo_rn`:request_no
