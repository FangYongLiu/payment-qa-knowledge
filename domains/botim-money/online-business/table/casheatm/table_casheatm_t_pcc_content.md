---
id: tbl_casheatm_t_pcc_content
object_type: Table
name: 支付授权凭证 (t_pcc_content)
aliases: [t_pcc_content, casheatm.t_pcc_content]
...
## 用途
物理表 `casheatm.t_pcc_content`,主键 `global_id`。支付授权凭证。业务语义细节**待补**(表结构来自 DDL)。
