---
id: tbl_casheatm_t_cash_in_order
object_type: Table
name: cash in 订单 (t_cash_in_order)
aliases: [t_cash_in_order, casheatm.t_cash_in_order]
...
# cash in 订单 (t_cash_in_order)

## 用途
物理表 `casheatm.t_cash_in_order`,主键 `global_id`。cash in 订单。业务语义细节**待补**(表结构来自 DDL)。
...
| `currency_code` | varchar(50) | 收单币种代码 · 可空 |
| `amount` | decimal(19, 4) | 收单金额 · 可空 |
| `fee_amount` | decimal(19, 4) | 待补 · 可空 |
| `payment_amount` | decimal(19, 4) | 待补 · 可空 |
