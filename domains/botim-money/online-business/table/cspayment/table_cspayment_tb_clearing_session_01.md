---
id: tbl_cspayment_tb_clearing_session_01
object_type: Table
name: 清算场次 (tb_clearing_session_01)
aliases: [tb_clearing_session_01, cspayment.tb_clearing_session_01]
...
# 清算场次 (tb_clearing_session_01)

## 用途
物理表 `cspayment.tb_clearing_session_01`,主键 `CLEARING_SESSION_ID`。清算场次。业务语义细节**待补**(表结构来自 DDL)。
...
- `IDX_CS_BATCH_NO_01`:BATCH_NO
- `IDX_CS_GMT_BOOKING_SHOW_01`:GMT_BOOKING_SHOW
