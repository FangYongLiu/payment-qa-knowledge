---
id: tbl_cspayment_tb_account_glide_02
object_type: Table
name: 入账流水 (tb_account_glide_02)
aliases: [tb_account_glide_02, cspayment.tb_account_glide_02]
...
# 入账流水 (tb_account_glide_02)

## 用途
物理表 `cspayment.tb_account_glide_02`,主键 `REQUEST_NO`。入账流水。业务语义细节**待补**(表结构来自 DDL)。
...
## 主键 / 索引
- 主键:`REQUEST_NO`
- `IDX_AG_CLEARING_SESSION_ID_02`:CLEARING_SESSION_ID
- `IDX_AG_GMTMODIFIED_02`:GMT_MODIFIED
- `IDX_AG_PAYMENT_SEQ_NO_02`:PAYMENT_SEQ_NO
- `idx_account_glide2_session_id`:CLEARING_SESSION_ID
