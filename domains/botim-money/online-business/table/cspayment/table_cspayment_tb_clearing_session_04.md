---
id: tbl_cspayment_tb_clearing_session_04
object_type: Table
name: 清算场次 (tb_clearing_session_04)
aliases: [tb_clearing_session_04, cspayment.tb_clearing_session_04]
...
# 清算场次 (tb_clearing_session_04)

## 用途
物理表 `cspayment.tb_clearing_session_04`,主键 `CLEARING_SESSION_ID`。清算场次。业务语义细节**待补**(表结构来自 DDL)。
...
- `IDX_CS_BATCH_NO_04`:BATCH_NO
- `IDX_CS_GMT_BOOKING_SHOW_04`:GMT_BOOKING_SHOW
