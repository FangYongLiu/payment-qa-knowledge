---
id: tbl_cspayment_tb_cs_carrier_00
object_type: Table
name: 清结算载体 (tb_cs_carrier_00)
aliases: [tb_cs_carrier_00, cspayment.tb_cs_carrier_00]
...
# 清结算载体 (tb_cs_carrier_00)

## 用途
物理表 `cspayment.tb_cs_carrier_00`,主键 `PAYMENT_SEQ_NO, PS_ID, CLEARING_CODE, REQUEST_TYPE`。清结算载体。业务语义细节**待补**(表结构来自 DDL)。
...
- `UK_CSC_REQUEST_NO_00`:REQUEST_NO (UNIQUE)
- `IDX_CSC_GMT_MODIFIED_00`:GMT_MODIFIED
- `IDX_CSC_SESSION_ID_00`:CLEARING_SESSION_ID
