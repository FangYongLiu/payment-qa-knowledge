---
id: tbl_cspayment_tb_clearing_order_inner_00
object_type: Table
name: 清算指令内场 (tb_clearing_order_inner_00)
aliases: [tb_clearing_order_inner_00, cspayment.tb_clearing_order_inner_00]
...
# 清算指令内场 (tb_clearing_order_inner_00)

## 用途
物理表 `cspayment.tb_clearing_order_inner_00`,主键 `CLEARING_ORDER_ID`。清算指令内场。业务语义细节**待补**(表结构来自 DDL)。
...
- `IDX_COI_REQUEST_NO_00`:REQUEST_NO
