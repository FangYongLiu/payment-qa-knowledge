---
id: tbl_cspayment_tb_settlement_order_03
object_type: Table
name: 结算指令 (tb_settlement_order_03)
aliases: [tb_settlement_order_03, cspayment.tb_settlement_order_03]
...
# 结算指令 (tb_settlement_order_03)

## 用途
物理表 `cspayment.tb_settlement_order_03`,主键 `SETTLEMENT_ORDER_ID`。结算指令。业务语义细节**待补**(表结构来自 DDL)。
...
- `IDX_SO_GMTMODIFIED_03`:GMT_MODIFIED
- `I_TB_SORDER_CSESSIONID_03`:CLEARING_SESSION_ID
- `I_TB_SORDER_PSEQNO_03`:PAYMENT_SEQ_NO
