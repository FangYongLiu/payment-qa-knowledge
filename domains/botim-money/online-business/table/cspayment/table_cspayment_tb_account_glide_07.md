---
id: tbl_cspayment_tb_account_glide_07
object_type: Table
name: 入账流水 (tb_account_glide_07)
aliases: [tb_account_glide_07, cspayment.tb_account_glide_07]
...
# 入账流水 (tb_account_glide_07)

## 用途
物理表 `cspayment.tb_account_glide_07`,主键 `REQUEST_NO`。入账流水。业务语义细节**待补**(表结构来自 DDL)。
...
## 主键 / 索引
- 主键:`REQUEST_NO`
- `IDX_AG_CLEARING_SESSION_ID_07`:CLEARING_SESSION_ID
- `IDX_AG_GMTMODIFIED_07`:GMT_MODIFIED
- `IDX_AG_PAYMENT_SEQ_NO_07`:PAYMENT_SEQ_NO
- `idx_account_glide7_session_id`:CLEARING_SESSION_ID
