---
id: tbl_cspayment_tb_account_glide_00
object_type: Table
name: 入账流水 (tb_account_glide_00)
aliases: [tb_account_glide_00, cspayment.tb_account_glide_00]
...
# 入账流水 (tb_account_glide_00)

## 用途
物理表 `cspayment.tb_account_glide_00`,主键 `REQUEST_NO`。入账流水。业务语义细节**待补**(表结构来自 DDL)。
...
## 主键 / 索引
- 主键:`REQUEST_NO`
- `IDX_AG_CLEARING_SESSION_ID_00`:CLEARING_SESSION_ID
- `IDX_AG_GMTMODIFIED_00`:GMT_MODIFIED
- `IDX_AG_PAYMENT_SEQ_NO_00`:PAYMENT_SEQ_NO
- `idx_account_glide0_session_id`:CLEARING_SESSION_ID
