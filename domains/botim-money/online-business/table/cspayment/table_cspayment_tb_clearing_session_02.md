---
id: tbl_cspayment_tb_clearing_session_02
object_type: Table
name: 清算场次 (tb_clearing_session_02)
aliases: [tb_clearing_session_02, cspayment.tb_clearing_session_02]
...
# 清算场次 (tb_clearing_session_02)

## 用途
物理表 `cspayment.tb_clearing_session_02`,主键 `CLEARING_SESSION_ID`。清算场次。业务语义细节**待补**(表结构来自 DDL)。
...
- `IDX_CS_BATCH_NO_02`:BATCH_NO
- `IDX_CS_GMT_BOOKING_SHOW_02`:GMT_BOOKING_SHOW
