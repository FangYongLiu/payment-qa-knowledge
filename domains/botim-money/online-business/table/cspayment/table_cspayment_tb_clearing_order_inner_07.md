---
id: tbl_cspayment_tb_clearing_order_inner_07
object_type: Table
name: 清算指令内场 (tb_clearing_order_inner_07)
aliases: [tb_clearing_order_inner_07, cspayment.tb_clearing_order_inner_07]
...
# 清算指令内场 (tb_clearing_order_inner_07)

## 用途
物理表 `cspayment.tb_clearing_order_inner_07`,主键 `CLEARING_ORDER_ID`。清算指令内场。业务语义细节**待补**(表结构来自 DDL)。
...
- `IDX_COI_REQUEST_NO_07`:REQUEST_NO
