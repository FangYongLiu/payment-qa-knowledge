---
id: tbl_cspayment_tb_account_glide_09
object_type: Table
name: 入账流水 (tb_account_glide_09)
aliases: [tb_account_glide_09, cspayment.tb_account_glide_09]
...
# 入账流水 (tb_account_glide_09)

## 用途
物理表 `cspayment.tb_account_glide_09`,主键 `REQUEST_NO`。入账流水。业务语义细节**待补**(表结构来自 DDL)。
...
## 主键 / 索引
- 主键:`REQUEST_NO`
- `IDX_AG_CLEARING_SESSION_ID_09`:CLEARING_SESSION_ID
- `IDX_AG_GMTMODIFIED_09`:GMT_MODIFIED
- `IDX_AG_PAYMENT_SEQ_NO_09`:PAYMENT_SEQ_NO
- `idx_account_glide9_session_id`:CLEARING_SESSION_ID
