---
id: tbl_cspayment_tb_settlement_order_09
object_type: Table
name: 结算指令 (tb_settlement_order_09)
aliases: [tb_settlement_order_09, cspayment.tb_settlement_order_09]
...
# 结算指令 (tb_settlement_order_09)

## 用途
物理表 `cspayment.tb_settlement_order_09`,主键 `SETTLEMENT_ORDER_ID`。结算指令。业务语义细节**待补**(表结构来自 DDL)。
...
- `IDX_SO_GMTMODIFIED_09`:GMT_MODIFIED
- `I_TB_SORDER_CSESSIONID_09`:CLEARING_SESSION_ID
- `I_TB_SORDER_PSEQNO_09`:PAYMENT_SEQ_NO
