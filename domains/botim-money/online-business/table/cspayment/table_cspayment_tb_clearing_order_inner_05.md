---
id: tbl_cspayment_tb_clearing_order_inner_05
object_type: Table
name: 清算指令内场 (tb_clearing_order_inner_05)
aliases: [tb_clearing_order_inner_05, cspayment.tb_clearing_order_inner_05]
...
# 清算指令内场 (tb_clearing_order_inner_05)

## 用途
物理表 `cspayment.tb_clearing_order_inner_05`,主键 `CLEARING_ORDER_ID`。清算指令内场。业务语义细节**待补**(表结构来自 DDL)。
...
- `IDX_COI_REQUEST_NO_05`:REQUEST_NO
