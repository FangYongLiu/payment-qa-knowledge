...
object_type: Table
name: reversal订单 (t_fiserv_reversal_order)
...
# reversal订单 (t_fiserv_reversal_order)

## 用途
物理表 `acquireii.t_fiserv_reversal_order`,主键 `global_id`。reversal订单。业务语义细节**待补**(表结构来自 DDL)。
