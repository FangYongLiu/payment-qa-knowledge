---
id: tbl_member_tm_vip_residence_contact_detail
object_type: Table
name: VIP Customer Residence and Contact Info (tm_vip_residence_contact_detail)
aliases: [tm_vip_residence_contact_detail, member.tm_vip_residence_contact_detail]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
# VIP Customer Residence and Contact Info (tm_vip_residence_contact_detail)

## 用途
物理表 `member.tm_vip_residence_contact_detail`,主键 `id`。VIP Customer Residence and Contact Info。业务语义细节**待补**(表结构来自 DDL)。
