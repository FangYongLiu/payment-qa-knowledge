---
id: tbl_member_tm_vip_sponsor_contact_detail
object_type: Table
name: VIP Sponsor Info (tm_vip_sponsor_contact_detail)
aliases: [tm_vip_sponsor_contact_detail, member.tm_vip_sponsor_contact_detail]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
# VIP Sponsor Info (tm_vip_sponsor_contact_detail)

## 用途
物理表 `member.tm_vip_sponsor_contact_detail`,主键 `id`。VIP Sponsor Info。业务语义细节**待补**(表结构来自 DDL)。
