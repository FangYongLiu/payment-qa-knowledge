---
id: tbl_member_tm_vip_visa_detail
object_type: Table
name: Active Visa (tm_vip_visa_detail)
aliases: [tm_vip_visa_detail, member.tm_vip_visa_detail]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
# Active Visa (tm_vip_visa_detail)

## 用途
物理表 `member.tm_vip_visa_detail`,主键 `id`。Active Visa。业务语义细节**待补**(表结构来自 DDL)。
