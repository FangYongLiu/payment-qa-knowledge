---
id: tbl_member_tm_vip_immigration_doc
object_type: Table
name: VIP Immigration and Documents (tm_vip_immigration_doc)
aliases: [tm_vip_immigration_doc, member.tm_vip_immigration_doc]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
# VIP Immigration and Documents (tm_vip_immigration_doc)

## 用途
物理表 `member.tm_vip_immigration_doc`,主键 `id`。VIP Immigration and Documents。业务语义细节**待补**(表结构来自 DDL)。
