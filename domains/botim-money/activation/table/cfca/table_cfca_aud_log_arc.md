---
id: tbl_cfca_aud_log_arc
object_type: Table
name: aud_log_arc (aud_log_arc)
aliases: [aud_log_arc, cfca.aud_log_arc]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
# aud_log_arc (aud_log_arc)

## 用途
物理表 `cfca.aud_log_arc`,主键 `id`。(DDL 未提供表注释)。业务语义细节**待补**(表结构来自 DDL)。
