---
id: tbl_ppcenter_t_biz_product_group
object_type: Table
domain: activation
status: active
owner: xiaoyan.zhou
...
module: null
sensitivity: normal
name: 业务产品分组(t_biz_product_group)
aliases:
- t_biz_product_group
related_services:
- svc_ppcenter
related_scenarios: []
---
# 业务产品分组(t_biz_product_group)

## 用途
业务产品分组。属 ppcenter 库,由 [[svc_ppcenter]] 读写。
