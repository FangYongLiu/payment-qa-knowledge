---
id: tbl_ups_leaf_alloc
object_type: Table
name: ups表主键生成规则 (leaf_alloc)
aliases: [leaf_alloc, ups.leaf_alloc]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
# ups表主键生成规则 (leaf_alloc)

## 用途
物理表 `ups.leaf_alloc`,主键 `biz_tag`。ups表主键生成规则。业务语义细节**待补**(表结构来自 DDL)。
