---
id: tbl_ups_t_ups_user_mark
object_type: Table
name: 用户标识 (t_ups_user_mark)
aliases: [t_ups_user_mark, ups.t_ups_user_mark]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
# 用户标识 (t_ups_user_mark)

## 用途
物理表 `ups.t_ups_user_mark`,主键 `id`。用户标识。业务语义细节**待补**(表结构来自 DDL)。
