---
id: tbl_basiscustomer_t_sys_notice
object_type: Table
name: 通知表 (t_sys_notice)
aliases: [t_sys_notice, basiscustomer.t_sys_notice]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
## 用途
物理表 `basiscustomer.t_sys_notice`,主键 `notice_id`。通知表。业务语义细节**待补**(表结构来自 DDL)。
