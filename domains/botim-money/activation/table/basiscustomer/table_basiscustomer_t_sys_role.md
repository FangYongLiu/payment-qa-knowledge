---
id: tbl_basiscustomer_t_sys_role
object_type: Table
name: 角色表 (t_sys_role)
aliases: [t_sys_role, basiscustomer.t_sys_role]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
## 用途
物理表 `basiscustomer.t_sys_role`,主键 `role_id`。角色表。业务语义细节**待补**(表结构来自 DDL)。
