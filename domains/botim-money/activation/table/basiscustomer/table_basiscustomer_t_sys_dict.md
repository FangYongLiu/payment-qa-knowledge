---
id: tbl_basiscustomer_t_sys_dict
object_type: Table
name: 基础字典 (t_sys_dict)
aliases: [t_sys_dict, basiscustomer.t_sys_dict]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
## 用途
物理表 `basiscustomer.t_sys_dict`,主键 `dict_id`。基础字典。业务语义细节**待补**(表结构来自 DDL)。
...
| `sort` | int | 排序 · 可空 |
| `description` | varchar(255) | 字典的描述 · 可空 |
