---
id: tbl_basiscustomer_t_sys_dept
object_type: Table
name: 部门表 (t_sys_dept)
aliases: [t_sys_dept, basiscustomer.t_sys_dept]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
## 用途
物理表 `basiscustomer.t_sys_dept`,主键 `dept_id`。部门表。业务语义细节**待补**(表结构来自 DDL)。
