---
id: flow_eid_renew_flow_overview
object_type: Flow
name: EID续期(EID Renew)端到端流程总览
aliases: [eid-renew-flow-overview]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
related_tables: [tbl_kyc_tm_audit_task, tbl_kyc_tm_biz_record, tbl_kyc_tm_eid_expiry_notify_event, tbl_kyc_tm_kyc_apply, tbl_kyc_tr_biz_record_live, tbl_kyc_tr_biz_record_ocr, tbl_kyc_tr_biz_record_verify]
---
