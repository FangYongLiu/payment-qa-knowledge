---
id: reference_botim_payby_server_integration_overview
object_type: Reference
name: Botim-PayBy服务端集成方案总览
aliases: [botim-payby-server-integration-overview]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
related_services: [svc_member, svc_onboarding, svc_personal]
related_tables: []
---
