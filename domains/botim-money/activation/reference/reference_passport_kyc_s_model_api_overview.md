---
id: reference_passport_kyc_s_model_api_overview
object_type: Reference
name: Passport KYC S-Model API 总览
aliases: [passport-kyc-s-model-api-overview]
domain: activation
status: active
owner: xinwei.cao
reviewer: xinwei.cao
...
related_tables: [tbl_kyc_tm_kyc_apply, tbl_kyc_tr_biz_record_passport, tbl_kyc_tr_biz_record_passport_live]
---
