---
id: tbl_pfs_tb_message_08
object_type: Table
name: 增长，10000行/天，至少保留三个月 (tb_message_08)
aliases: [tb_message_08, pfs.tb_message_08]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
# 增长，10000行/天，至少保留三个月 (tb_message_08)

## 用途
物理表 `pfs.tb_message_08`,主键 `MESSAGE_ID`。增长，10000行/天，至少保留三个月。业务语义细节**待补**(表结构来自 DDL)。
...
## 主键 / 索引
- 主键:`MESSAGE_ID`
- `I_MESSAGE_GMTALLOW_08`:GMT_ALLOW
- `I_MESSAGE_GMTMODIFY_08`:GMT_MODIFY
- `I_MESSAGE_MESSAGEKEY_08`:MESSAGE_KEY
