---
id: tbl_pfs_tb_message_01
object_type: Table
name: 增长，10000行/天，至少保留三个月 (tb_message_01)
aliases: [tb_message_01, pfs.tb_message_01]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
# 增长，10000行/天，至少保留三个月 (tb_message_01)

## 用途
物理表 `pfs.tb_message_01`,主键 `MESSAGE_ID`。增长，10000行/天，至少保留三个月。业务语义细节**待补**(表结构来自 DDL)。
...
## 主键 / 索引
- 主键:`MESSAGE_ID`
- `I_MESSAGE_GMTALLOW_01`:GMT_ALLOW
- `I_MESSAGE_GMTMODIFY_01`:GMT_MODIFY
- `I_MESSAGE_MESSAGEKEY_01`:MESSAGE_KEY
