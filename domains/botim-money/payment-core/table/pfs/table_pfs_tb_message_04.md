---
id: tbl_pfs_tb_message_04
object_type: Table
name: 增长，10000行/天，至少保留三个月 (tb_message_04)
aliases: [tb_message_04, pfs.tb_message_04]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
# 增长，10000行/天，至少保留三个月 (tb_message_04)

## 用途
物理表 `pfs.tb_message_04`,主键 `MESSAGE_ID`。增长，10000行/天，至少保留三个月。业务语义细节**待补**(表结构来自 DDL)。
...
## 主键 / 索引
- 主键:`MESSAGE_ID`
- `I_MESSAGE_GMTALLOW_04`:GMT_ALLOW
- `I_MESSAGE_GMTMODIFY_04`:GMT_MODIFY
- `I_MESSAGE_MESSAGEKEY_04`:MESSAGE_KEY
