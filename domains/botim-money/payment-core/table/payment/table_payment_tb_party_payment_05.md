...
object_type: Table
name: tb_party_payment_05 (tb_party_payment_05)
...
# tb_party_payment_05 (tb_party_payment_05)

## 用途
物理表 `payment.tb_party_payment_05`,主键 `PAYMENT_PARTY_ID`。(DDL 未提供表注释)。业务语义细节**待补**(表结构来自 DDL)。
