---
id: tbl_payment_tb_payment_state_his_06
object_type: Table
name: 记录支付状态的跃迁历史 (tb_payment_state_his_06)
aliases: [tb_payment_state_his_06, payment.tb_payment_state_his_06]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
# 记录支付状态的跃迁历史 (tb_payment_state_his_06)

## 用途
物理表 `payment.tb_payment_state_his_06`,主键 `HIS_ID`。记录支付状态的跃迁历史。业务语义细节**待补**(表结构来自 DDL)。
...
## 主键 / 索引
- 主键:`HIS_ID`
- `IDX_PAYMENT_STATE_HIS_PSN_06`:PAYMENT_SEQ_NO
