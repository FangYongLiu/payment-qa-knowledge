---
id: tbl_payment_tb_message_eventcode
object_type: Table
name: 稳定，100行 (tb_message_eventcode)
aliases: [tb_message_eventcode, payment.tb_message_eventcode]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
## 用途
物理表 `payment.tb_message_eventcode`,主键 `EVENT_CODE_ID`。稳定，100行。业务语义细节**待补**(表结构来自 DDL)。
