---
id: tbl_payment_tb_payment_order_09
object_type: Table
name: 支付指令 (tb_payment_order_09)
aliases: [tb_payment_order_09, payment.tb_payment_order_09]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
# 支付指令 (tb_payment_order_09)

## 用途
物理表 `payment.tb_payment_order_09`,主键 `PAYMENT_SEQ_NO`。支付指令。业务语义细节**待补**(表结构来自 DDL)。
...
## 主键 / 索引
- 主键:`PAYMENT_SEQ_NO`
- `IDX_PAYMENT_ORDER_BPSN_09`:BIZ_PAYMENT_SEQ_NO
- `IDX_PAYMENT_ORDER_CREATE_09`:GMT_CREATE
- `IDX_PAYMENT_ORDER_MODIFIED_09`:GMT_MODIFIED
- `IDX_PAYMENT_ORDER_PO_09`:PAYMENT_ORDER_NO
- `IDX_PAYMENT_ORDER_RPSN_09`:RELATE_PAYMENT_SEQ_NO
