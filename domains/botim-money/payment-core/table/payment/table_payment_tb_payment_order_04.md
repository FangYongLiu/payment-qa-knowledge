---
id: tbl_payment_tb_payment_order_04
object_type: Table
name: 支付指令 (tb_payment_order_04)
aliases: [tb_payment_order_04, payment.tb_payment_order_04]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
# 支付指令 (tb_payment_order_04)

## 用途
物理表 `payment.tb_payment_order_04`,主键 `PAYMENT_SEQ_NO`。支付指令。业务语义细节**待补**(表结构来自 DDL)。
...
## 主键 / 索引
- 主键:`PAYMENT_SEQ_NO`
- `IDX_PAYMENT_ORDER_BPSN_04`:BIZ_PAYMENT_SEQ_NO
- `IDX_PAYMENT_ORDER_CREATE_04`:GMT_CREATE
- `IDX_PAYMENT_ORDER_MODIFIED_04`:GMT_MODIFIED
- `IDX_PAYMENT_ORDER_PO_04`:PAYMENT_ORDER_NO
- `IDX_PAYMENT_ORDER_RPSN_04`:RELATE_PAYMENT_SEQ_NO
