---
id: tbl_payment_tb_message_config
object_type: Table
name: 稳定，100行 (tb_message_config)
aliases: [tb_message_config, payment.tb_message_config]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
## 用途
物理表 `payment.tb_message_config`,主键 `CONFIG_ID`。稳定，100行。业务语义细节**待补**(表结构来自 DDL)。
