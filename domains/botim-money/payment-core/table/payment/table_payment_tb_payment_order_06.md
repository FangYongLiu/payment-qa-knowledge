---
id: tbl_payment_tb_payment_order_06
object_type: Table
name: 支付指令 (tb_payment_order_06)
aliases: [tb_payment_order_06, payment.tb_payment_order_06]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
# 支付指令 (tb_payment_order_06)

## 用途
物理表 `payment.tb_payment_order_06`,主键 `PAYMENT_SEQ_NO`。支付指令。业务语义细节**待补**(表结构来自 DDL)。
...
## 主键 / 索引
- 主键:`PAYMENT_SEQ_NO`
- `IDX_PAYMENT_ORDER_BPSN_06`:BIZ_PAYMENT_SEQ_NO
- `IDX_PAYMENT_ORDER_CREATE_06`:GMT_CREATE
- `IDX_PAYMENT_ORDER_MODIFIED_06`:GMT_MODIFIED
- `IDX_PAYMENT_ORDER_PO_06`:PAYMENT_ORDER_NO
- `IDX_PAYMENT_ORDER_RPSN_06`:RELATE_PAYMENT_SEQ_NO
