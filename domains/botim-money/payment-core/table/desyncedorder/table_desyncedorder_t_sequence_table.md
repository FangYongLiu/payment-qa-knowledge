---
id: tbl_desyncedorder_t_sequence_table
object_type: Table
name: 序号生成表 (t_sequence_table)
aliases: [t_sequence_table, desyncedorder.t_sequence_table]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
## 用途
物理表 `desyncedorder.t_sequence_table`,主键 `sequence_name`。序号生成表。业务语义细节**待补**(表结构来自 DDL)。
