---
id: tbl_ues_tb_en_data_55
object_type: Table
name: tb_en_data_55 (tb_en_data_55)
aliases: [tb_en_data_55, ues.tb_en_data_55]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
# tb_en_data_55 (tb_en_data_55)

## 用途
物理表 `ues.tb_en_data_55`,主键 `None`。(DDL 未提供表注释)。业务语义细节**待补**(表结构来自 DDL)。
