---
id: tbl_ues_tb_en_data_39
object_type: Table
name: tb_en_data_39 (tb_en_data_39)
aliases: [tb_en_data_39, ues.tb_en_data_39]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
# tb_en_data_39 (tb_en_data_39)

## 用途
物理表 `ues.tb_en_data_39`,主键 `None`。(DDL 未提供表注释)。业务语义细节**待补**(表结构来自 DDL)。
