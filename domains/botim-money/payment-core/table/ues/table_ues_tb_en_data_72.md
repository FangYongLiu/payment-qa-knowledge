---
id: tbl_ues_tb_en_data_72
object_type: Table
name: tb_en_data_72 (tb_en_data_72)
aliases: [tb_en_data_72, ues.tb_en_data_72]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
# tb_en_data_72 (tb_en_data_72)

## 用途
物理表 `ues.tb_en_data_72`,主键 `None`。(DDL 未提供表注释)。业务语义细节**待补**(表结构来自 DDL)。
