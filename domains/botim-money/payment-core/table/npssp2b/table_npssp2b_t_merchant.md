---
id: tbl_npssp2b_t_merchant
object_type: Table
name: Merchant table with online info (t_merchant)
aliases: [t_merchant, npssp2b.t_merchant]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
source_type: DB DDL
source_ref: npssp2b schema DDL
tags: [payment-core, npssp2b]
sensitivity: normal
related_services: []
---
...
## 用途
物理表 `npssp2b.t_merchant`,主键 `merchant_id`。Merchant table with online info。业务语义细节**待补**(表结构来自 DDL)。
