---
id: reference_payby_acquire_transaction_overview
object_type: Reference
name: PayBy收单交易业务总览
aliases: [payby-acquire-transaction-overview]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
related_services: [svc_acquireii, svc_aml, svc_authpay, svc_cashdesk_api, svc_cashierii, svc_cmf, svc_counter, svc_fcw, svc_member, svc_merchant, svc_merchant_frontend, svc_merchant_fundout, svc_payment, svc_pbs, svc_pfs_payment, svc_qpay_mpgs, svc_reconciliation, svc_router, svc_sgs]
related_tables: []
---
