---
id: reference_pix_wechat_mpc_integration_overview
object_type: Reference
name: 微信MPC渠道接入总览(pix-RA-2405)
aliases: [pix-wechat-mpc-integration-overview]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
related_services: [svc_basis_customer, svc_payment, svc_pix, svc_reconciliation, svc_remittance]
related_tables: []
---
