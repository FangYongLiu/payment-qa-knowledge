---
id: reference_payby_core_systems_overview
object_type: Reference
name: PayBy核心系统简介
aliases: [payby-core-systems-overview]
domain: payment-core
status: active
owner: xiaoyan.zhou
...
related_services: [svc_aml, svc_cashierii, svc_cgs, svc_cmf, svc_deposit, svc_dpm_accounting, svc_dpm_manager, svc_fundout, svc_member, svc_payment, svc_pfs_payment, svc_ppcenter, svc_sgs, svc_tradeii]
related_tables: []
---
