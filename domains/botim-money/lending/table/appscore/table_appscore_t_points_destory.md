---
id: tbl_appscore_t_points_destory
object_type: Table
name: 积分销毁 (t_points_destory)
aliases: [t_points_destory, appscore.t_points_destory]
domain: lending
status: active
owner: Xiaopei.Yan
...
# 积分销毁 (t_points_destory)

## 用途
物理表 `appscore.t_points_destory`,主键 `destory_points_no`。积分销毁。业务语义细节**待补**(表结构来自 DDL)。
...
| 列 | 类型 | 说明 |
| --- | --- | --- |
| `destory_points_no` | bigint(18) | 主键 |
...
| `accessory_content` | varchar(255) | 附属内容 · 可空 |
