---
id: tbl_botimsnpl_t_sl_autodebit_protocol
object_type: Table
name: autodebit 协议 (t_sl_autodebit_protocol)
aliases: [t_sl_autodebit_protocol, botimsnpl.t_sl_autodebit_protocol]
domain: lending
status: active
owner: Xiaopei.Yan
...
# autodebit 协议 (t_sl_autodebit_protocol)

## 用途
物理表 `botimsnpl.t_sl_autodebit_protocol`,主键 `id`。autodebit 协议。业务语义细节**待补**(表结构来自 DDL)。
