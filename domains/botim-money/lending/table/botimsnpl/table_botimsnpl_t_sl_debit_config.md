---
id: tbl_botimsnpl_t_sl_debit_config
object_type: Table
name: autodebit (t_sl_debit_config)
aliases: [t_sl_debit_config, botimsnpl.t_sl_debit_config]
domain: lending
status: active
owner: Xiaopei.Yan
...
# autodebit (t_sl_debit_config)

## 用途
物理表 `botimsnpl.t_sl_debit_config`,主键 `id`。autodebit。业务语义细节**待补**(表结构来自 DDL)。
...
| `fail_context` | varchar(1000) | 短信内容 · 可空 |
