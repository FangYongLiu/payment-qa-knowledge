---
id: tbl_credit_t_cs_bill_info
object_type: Table
name: 帐单信息表 (t_cs_bill_info)
aliases: [t_cs_bill_info, credit.t_cs_bill_info]
domain: lending
status: active
owner: Xiaopei.Yan
...
# 帐单信息表 (t_cs_bill_info)

## 用途
物理表 `credit.t_cs_bill_info`,主键 `id`。帐单信息表。业务语义细节**待补**(表结构来自 DDL)。
