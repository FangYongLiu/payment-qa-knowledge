---
id: tbl_credit_t_cs_paylater_order
object_type: Table
name: 交易订单表 (t_cs_paylater_order)
aliases: [t_cs_paylater_order, credit.t_cs_paylater_order]
domain: lending
status: active
owner: Xiaopei.Yan
...
# 交易订单表 (t_cs_paylater_order)

## 用途
物理表 `credit.t_cs_paylater_order`,主键 `id`。交易订单表。业务语义细节**待补**(表结构来自 DDL)。
