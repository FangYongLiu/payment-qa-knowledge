---
id: tbl_sme_t_repay_split_yeahka
object_type: Table
name: Payment sharing account (t_repay_split_yeahka)
aliases: [t_repay_split_yeahka, sme.t_repay_split_yeahka]
domain: lending
status: active
owner: Xiaopei.Yan
...
# Payment sharing account (t_repay_split_yeahka)

## 用途
物理表 `sme.t_repay_split_yeahka`,主键 `id`。Payment sharing account。业务语义细节**待补**(表结构来自 DDL)。
