---
id: tbl_sme_t_bill_to_user
object_type: Table
name: Bill sheet (t_bill_to_user)
aliases: [t_bill_to_user, sme.t_bill_to_user]
domain: lending
status: active
owner: Xiaopei.Yan
...
# Bill sheet (t_bill_to_user)

## 用途
物理表 `sme.t_bill_to_user`,主键 `id`。Bill sheet。业务语义细节**待补**(表结构来自 DDL)。
...
| `cope_interest` | decimal(15, 2) | Interest payable refers to the interest receivable from the user at the end of the term |
| `cope_penalty` | decimal(15, 2) | The penalty should be repaid · 可空 |
| `already_repay_capital` | decimal(15, 2) | Repaid principal · 可空 |
| `already_repay_interest` | decimal(15, 2) | Interest paid · 可空 |
| `already_repay_penalty` | decimal(15, 2) | The penalty interest has been repaid · 可空 |
| `unaccrued_interest_waiver` | decimal(15, 2) | Waive unpaid interest · 可空 |
