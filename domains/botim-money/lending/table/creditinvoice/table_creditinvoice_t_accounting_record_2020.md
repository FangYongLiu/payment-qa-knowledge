---
id: tbl_creditinvoice_t_accounting_record_2020
object_type: Table
name: accounting record table (t_accounting_record_2020)
aliases: [t_accounting_record_2020, creditinvoice.t_accounting_record_2020]
domain: lending
status: active
owner: Xiaopei.Yan
...
# accounting record table (t_accounting_record_2020)

## 用途
物理表 `creditinvoice.t_accounting_record_2020`,主键 `id`。accounting record table。业务语义细节**待补**(表结构来自 DDL)。
