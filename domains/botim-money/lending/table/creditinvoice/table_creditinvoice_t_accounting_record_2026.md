---
id: tbl_creditinvoice_t_accounting_record_2026
object_type: Table
name: accounting record table (t_accounting_record_2026)
aliases: [t_accounting_record_2026, creditinvoice.t_accounting_record_2026]
domain: lending
status: active
owner: Xiaopei.Yan
...
# accounting record table (t_accounting_record_2026)

## 用途
物理表 `creditinvoice.t_accounting_record_2026`,主键 `id`。accounting record table。业务语义细节**待补**(表结构来自 DDL)。
