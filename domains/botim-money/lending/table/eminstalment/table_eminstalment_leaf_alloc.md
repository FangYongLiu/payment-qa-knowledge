---
id: tbl_eminstalment_leaf_alloc
object_type: Table
name: 唯一ID生成 (leaf_alloc)
aliases: [leaf_alloc, eminstalment.leaf_alloc]
domain: lending
status: active
owner: Xiaopei.Yan
...
## 用途
物理表 `eminstalment.leaf_alloc`,主键 `biz_tag`。唯一ID生成。业务语义细节**待补**(表结构来自 DDL)。
