---
id: tbl_botimcredit_t_cb_ins_split
object_type: Table
name: 还款分帐 (t_cb_ins_split)
aliases: [t_cb_ins_split, botimcredit.t_cb_ins_split]
domain: lending
status: active
owner: Xiaopei.Yan
...
## 用途
物理表 `botimcredit.t_cb_ins_split`,主键 `id`。还款分帐。业务语义细节**待补**(表结构来自 DDL)。
