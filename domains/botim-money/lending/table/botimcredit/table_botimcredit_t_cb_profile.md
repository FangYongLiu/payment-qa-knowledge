---
id: tbl_botimcredit_t_cb_profile
object_type: Table
name: 用户信息 (t_cb_profile)
aliases: [t_cb_profile, botimcredit.t_cb_profile]
domain: lending
status: active
owner: Xiaopei.Yan
...
## 用途
物理表 `botimcredit.t_cb_profile`,主键 `id`。用户信息。业务语义细节**待补**(表结构来自 DDL)。
...
| `identity_invalid_time` | varchar(10) | 待补 · 可空 |
