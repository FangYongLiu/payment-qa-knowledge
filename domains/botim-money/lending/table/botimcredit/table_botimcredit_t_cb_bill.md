---
id: tbl_botimcredit_t_cb_bill
object_type: Table
name: 帐单信息表 (t_cb_bill)
aliases: [t_cb_bill, botimcredit.t_cb_bill]
domain: lending
status: active
owner: Xiaopei.Yan
...
## 用途
物理表 `botimcredit.t_cb_bill`,主键 `id`。帐单信息表。业务语义细节**待补**(表结构来自 DDL)。
