---
id: tbl_botimcredit_t_cb_instalment
object_type: Table
name: 帐单表 (t_cb_instalment)
aliases: [t_cb_instalment, botimcredit.t_cb_instalment]
domain: lending
status: active
owner: Xiaopei.Yan
...
## 用途
物理表 `botimcredit.t_cb_instalment`,主键 `id`。帐单表。业务语义细节**待补**(表结构来自 DDL)。
