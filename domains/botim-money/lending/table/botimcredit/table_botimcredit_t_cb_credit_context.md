---
id: tbl_botimcredit_t_cb_credit_context
object_type: Table
name: 授信上下文 (t_cb_credit_context)
aliases: [t_cb_credit_context, botimcredit.t_cb_credit_context]
domain: lending
status: active
owner: Xiaopei.Yan
...
# 授信上下文 (t_cb_credit_context)

## 用途
物理表 `botimcredit.t_cb_credit_context`,主键 `id`。授信上下文。业务语义细节**待补**(表结构来自 DDL)。
