---
id: tbl_botimcredit_t_cb_fee_changelog
object_type: Table
name: 费用记录表 (t_cb_fee_changelog)
aliases: [t_cb_fee_changelog, botimcredit.t_cb_fee_changelog]
domain: lending
status: active
owner: Xiaopei.Yan
...
# 费用记录表 (t_cb_fee_changelog)

## 用途
物理表 `botimcredit.t_cb_fee_changelog`,主键 `id`。费用记录表。业务语义细节**待补**(表结构来自 DDL)。
