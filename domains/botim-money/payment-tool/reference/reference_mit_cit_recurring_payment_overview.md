---
id: reference_mit_cit_recurring_payment_overview
object_type: Reference
name: MIT/CIT 循环支付（MPGS）功能概览
aliases: [mit-cit-recurring-payment-overview]
domain: payment-tool
status: active
owner: kingo.liang
...
tags: [payment-tool, wiki-overview]
related_services: [svc_3ds2, svc_acquireii, svc_acs, svc_deduct, svc_member, svc_qpay_cko, svc_qpay_mpgs]
related_tables: [tbl_acquireii_t_card_info, tbl_deduct_t_deduct_protocol, tbl_member_tr_bank_account]
---
