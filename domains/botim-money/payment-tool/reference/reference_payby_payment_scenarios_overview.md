---
id: reference_payby_payment_scenarios_overview
object_type: Reference
name: PayBy支付场景现状梳理(DirectPay/PayAndSign/AutoDebit)
aliases: [payby-payment-scenarios-overview]
domain: payment-tool
status: active
owner: kingo.liang
