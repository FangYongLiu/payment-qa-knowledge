---
id: flow_chargeback_process_overview
object_type: Flow
name: Chargeback 端到端处理流程总览
aliases: [chargeback-process-overview]
domain: payment-tool
status: active
owner: kingo.liang
...
related_services: [svc_cmf, svc_reconciliation]
related_tables: [tbl_cmf_tt_inst_order]
---
