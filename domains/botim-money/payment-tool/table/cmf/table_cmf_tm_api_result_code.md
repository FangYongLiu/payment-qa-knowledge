---
id: tbl_cmf_tm_api_result_code
object_type: Table
name: API结果编码 (tm_api_result_code)
aliases: [tm_api_result_code, cmf.tm_api_result_code]
domain: payment-tool
status: active
owner: kingo.liang
...
## 用途
物理表 `cmf.tm_api_result_code`,主键 `API_RESULT_CODE_ID`。API结果编码。业务语义细节**待补**(表结构来自 DDL)。
...
| 列 | 类型 | 说明 |
| --- | --- | --- |
| `API_RESULT_CODE_ID` | int unsigned | 编码ID，SEQ_API_RESULT_CODE · 可空 |
| `FUND_CHANNEL_CODE` | varchar(32) | 资金源编码 |
| `API_TYPE` | varchar(16) | 接口类型 · 可空 |
