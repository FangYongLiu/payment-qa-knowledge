---
id: tbl_cmf_tm_unity_result_code
object_type: Table
name: 统一结果代码 (tm_unity_result_code)
aliases: [tm_unity_result_code, cmf.tm_unity_result_code]
domain: payment-tool
status: active
owner: kingo.liang
...
## 用途
物理表 `cmf.tm_unity_result_code`,主键 `UNITY_RESULT_CODE`。统一结果代码。业务语义细节**待补**(表结构来自 DDL)。
