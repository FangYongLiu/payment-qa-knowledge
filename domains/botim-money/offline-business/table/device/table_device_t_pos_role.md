---
id: tbl_device_t_pos_role
object_type: Table
name: POS角色 (t_pos_role)
aliases: [t_pos_role, device.t_pos_role]
...
## 用途
物理表 `device.t_pos_role`,主键 `id`。POS角色。业务语义细节**待补**(表结构来自 DDL)。
...
| `name` | varchar(50) | 名称 |
| `access_menu_list` | varchar(500) | 权限列表 · 可空 |
...
## 主键 / 索引
- 主键:`id`
- `UDX_NAME_MID`:merchant_mid, name (UNIQUE)
