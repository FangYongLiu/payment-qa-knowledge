---
id: tbl_acquire_t_request_identity
object_type: Table
name: 请求标识 (t_request_identity)
aliases: [t_request_identity, acquire.t_request_identity]
...
## 用途
物理表 `acquire.t_request_identity`,主键 `global_id`。请求标识。业务语义细节**待补**(表结构来自 DDL)。
...
| `voucher_type` | varchar(200) | 凭证类型 |
| `created_time` | timestamp(3) | 创建时间 |

## 主键 / 索引
- 主键:`global_id`
- `i_ri_or`:issuer_type, issuer_code, out_request_no
- `i_ri_vn`:voucher_no
