---
id: tbl_reconciliation_t_fcy_balance
object_type: Table
name: FCY BALANCE (t_fcy_balance)
aliases: [t_fcy_balance, reconciliation.t_fcy_balance]
domain: settlement
status: active
owner: xiaoyan.zhou
...
# FCY BALANCE (t_fcy_balance)

## 用途
物理表 `reconciliation.t_fcy_balance`,主键 `id`。FCY BALANCE。业务语义细节**待补**(表结构来自 DDL)。
...
| `fx_purchase` | decimal(19, 4) | Fx Purchase · 可空 |
