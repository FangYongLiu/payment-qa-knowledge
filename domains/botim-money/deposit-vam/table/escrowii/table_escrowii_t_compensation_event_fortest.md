---
id: tbl_escrowii_t_compensation_event_fortest
object_type: Table
name: Compensation event (t_compensation_event_fortest)
aliases: [t_compensation_event_fortest, escrowii.t_compensation_event_fortest]
domain: deposit-vam
status: active
owner: xiaoyan.zhou
...
# Compensation event (t_compensation_event_fortest)

## 用途
物理表 `escrowii.t_compensation_event_fortest`,主键 `event_id`。Compensation event。业务语义细节**待补**(表结构来自 DDL)。
