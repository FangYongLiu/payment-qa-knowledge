---
id: tbl_devicefpii_device_score_scale
object_type: Table
name: device_score_scale (device_score_scale)
aliases: [device_score_scale, devicefpii.device_score_scale]
domain: risk
status: active
...
## 用途
物理表 `devicefpii.device_score_scale`,主键 `id`。(DDL 未提供表注释)。业务语义细节**待补**(表结构来自 DDL)。
