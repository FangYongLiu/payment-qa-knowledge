---
id: tbl_devicefpii_constid_script_config
object_type: Table
name: constid_script_config (constid_script_config)
aliases: [constid_script_config, devicefpii.constid_script_config]
domain: risk
status: active
...
## 用途
物理表 `devicefpii.constid_script_config`,主键 `id`。(DDL 未提供表注释)。业务语义细节**待补**(表结构来自 DDL)。
