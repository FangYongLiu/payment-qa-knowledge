---
id: tbl_devicefp_user_active_statistics
object_type: Table
name: user_active_statistics (user_active_statistics)
aliases: [user_active_statistics, devicefp.user_active_statistics]
domain: risk
status: active
...
## 用途
物理表 `devicefp.user_active_statistics`,主键 `id`。(DDL 未提供表注释)。业务语义细节**待补**(表结构来自 DDL)。
