---
id: tbl_devicefp_monitor_alarm_record
object_type: Table
name: monitor_alarm_record (monitor_alarm_record)
aliases: [monitor_alarm_record, devicefp.monitor_alarm_record]
domain: risk
status: active
...
## 用途
物理表 `devicefp.monitor_alarm_record`,主键 `id`。(DDL 未提供表注释)。业务语义细节**待补**(表结构来自 DDL)。
