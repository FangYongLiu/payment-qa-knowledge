---
id: tbl_basicrcdata_t_cs_bill
object_type: Table
name: zfjs实例中credit库的帐单表 (t_cs_bill)
aliases: [t_cs_bill, basicrcdata.t_cs_bill]
domain: risk
status: active
...
# zfjs实例中credit库的帐单表 (t_cs_bill)

## 用途
物理表 `basicrcdata.t_cs_bill`,主键 `id`。zfjs实例中credit库的帐单表。业务语义细节**待补**(表结构来自 DDL)。
