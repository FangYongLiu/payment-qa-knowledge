---
id: tbl_basicrcdata_geolite2_city_blocks_ipv4
object_type: Table
name: geolite2_city_blocks_ipv4 (geolite2_city_blocks_ipv4)
aliases: [geolite2_city_blocks_ipv4, basicrcdata.geolite2_city_blocks_ipv4]
domain: risk
status: active
...
# geolite2_city_blocks_ipv4 (geolite2_city_blocks_ipv4)

## 用途
物理表 `basicrcdata.geolite2_city_blocks_ipv4`,主键 `id`。(DDL 未提供表注释)。业务语义细节**待补**(表结构来自 DDL)。
...
| `latitude` | int(10) | 维度 · 可空 |
| `longitude` | int(10) | 经度 · 可空 |
