---
id: tbl_promo_t_cd_camp_promo_code_conf
object_type: Table
name: campaign promo code conf (t_cd_camp_promo_code_conf)
aliases: [t_cd_camp_promo_code_conf, promo.t_cd_camp_promo_code_conf]
domain: marketing
status: active
owner: wujiang.ding
...
# campaign promo code conf (t_cd_camp_promo_code_conf)

## 用途
物理表 `promo.t_cd_camp_promo_code_conf`,主键 `id`。campaign promo code conf。业务语义细节**待补**(表结构来自 DDL)。
