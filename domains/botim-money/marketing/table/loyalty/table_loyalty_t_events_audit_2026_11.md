---
id: tbl_loyalty_t_events_audit_2026_11
object_type: Table
name: Audit log of all processed events from at-beb - 2026-11 (t_events_audit_2026_11)
aliases: [t_events_audit_2026_11, loyalty.t_events_audit_2026_11]
domain: marketing
status: active
owner: wujiang.ding
...
# Audit log of all processed events from at-beb - 2026-11 (t_events_audit_2026_11)

## 用途
物理表 `loyalty.t_events_audit_2026_11`,主键 `id`。Audit log of all processed events from at-beb - 2026-11。业务语义细节**待补**(表结构来自 DDL)。
