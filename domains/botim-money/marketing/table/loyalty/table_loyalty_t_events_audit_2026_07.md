---
id: tbl_loyalty_t_events_audit_2026_07
object_type: Table
name: Audit log of all processed events from at-beb - 2026-07 (t_events_audit_2026_07)
aliases: [t_events_audit_2026_07, loyalty.t_events_audit_2026_07]
domain: marketing
status: active
owner: wujiang.ding
...
# Audit log of all processed events from at-beb - 2026-07 (t_events_audit_2026_07)

## 用途
物理表 `loyalty.t_events_audit_2026_07`,主键 `id`。Audit log of all processed events from at-beb - 2026-07。业务语义细节**待补**(表结构来自 DDL)。
