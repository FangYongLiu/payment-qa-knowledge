---
id: tbl_loyalty_t_raffle_entries_2026_11
object_type: Table
name: Raffle entries from loyalty campaigns - 2026-11 (t_raffle_entries_2026_11)
aliases: [t_raffle_entries_2026_11, loyalty.t_raffle_entries_2026_11]
domain: marketing
status: active
owner: wujiang.ding
...
# Raffle entries from loyalty campaigns - 2026-11 (t_raffle_entries_2026_11)

## 用途
物理表 `loyalty.t_raffle_entries_2026_11`,主键 `id`。Raffle entries from loyalty campaigns - 2026-11。业务语义细节**待补**(表结构来自 DDL)。
