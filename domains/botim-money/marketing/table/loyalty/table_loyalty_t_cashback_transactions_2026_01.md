---
id: tbl_loyalty_t_cashback_transactions_2026_01
object_type: Table
name: Cashback reward transactions via Airdrop M2U API - 2026-01 (t_cashback_transactions_2026_01)
aliases: [t_cashback_transactions_2026_01, loyalty.t_cashback_transactions_2026_01]
domain: marketing
status: active
owner: wujiang.ding
...
# Cashback reward transactions via Airdrop M2U API - 2026-01 (t_cashback_transactions_2026_01)

## 用途
物理表 `loyalty.t_cashback_transactions_2026_01`,主键 `id`。Cashback reward transactions via Airdrop M2U API - 2026-01。业务语义细节**待补**(表结构来自 DDL)。
