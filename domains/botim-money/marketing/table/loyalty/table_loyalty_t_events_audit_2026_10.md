---
id: tbl_loyalty_t_events_audit_2026_10
object_type: Table
name: Audit log of all processed events from at-beb - 2026-10 (t_events_audit_2026_10)
aliases: [t_events_audit_2026_10, loyalty.t_events_audit_2026_10]
domain: marketing
status: active
owner: wujiang.ding
...
# Audit log of all processed events from at-beb - 2026-10 (t_events_audit_2026_10)

## 用途
物理表 `loyalty.t_events_audit_2026_10`,主键 `id`。Audit log of all processed events from at-beb - 2026-10。业务语义细节**待补**(表结构来自 DDL)。
