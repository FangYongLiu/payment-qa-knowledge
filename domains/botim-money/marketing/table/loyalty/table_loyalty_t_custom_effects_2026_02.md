---
id: tbl_loyalty_t_custom_effects_2026_02
object_type: Table
name: Custom effects from Talon.One - orchestration layer for reward processing - 2026-02 (t_custom_effects_2026_02)
aliases: [t_custom_effects_2026_02, loyalty.t_custom_effects_2026_02]
domain: marketing
status: active
owner: wujiang.ding
...
# Custom effects from Talon.One - orchestration layer for reward processing - 2026-02 (t_custom_effects_2026_02)

## 用途
物理表 `loyalty.t_custom_effects_2026_02`,主键 `id`。Custom effects from Talon.One - orchestration layer for reward processing - 2026-02。业务语义细节**待补**(表结构来自 DDL)。
...
| `effect_name` | varchar(100) | Custom effect name: cashback, vip_reward |
...
| `status` | varchar(20) | Processing status: pending|processing|completed|failed|permanently_failed |
