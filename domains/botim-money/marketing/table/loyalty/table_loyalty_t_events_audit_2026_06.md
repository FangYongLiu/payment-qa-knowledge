---
id: tbl_loyalty_t_events_audit_2026_06
object_type: Table
name: Audit log of all processed events from at-beb - 2026-06 (t_events_audit_2026_06)
aliases: [t_events_audit_2026_06, loyalty.t_events_audit_2026_06]
domain: marketing
status: active
owner: wujiang.ding
...
# Audit log of all processed events from at-beb - 2026-06 (t_events_audit_2026_06)

## 用途
物理表 `loyalty.t_events_audit_2026_06`,主键 `id`。Audit log of all processed events from at-beb - 2026-06。业务语义细节**待补**(表结构来自 DDL)。
