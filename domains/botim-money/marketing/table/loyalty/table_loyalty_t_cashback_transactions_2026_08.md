---
id: tbl_loyalty_t_cashback_transactions_2026_08
object_type: Table
name: Cashback reward transactions via Airdrop M2U API - 2026-08 (t_cashback_transactions_2026_08)
aliases: [t_cashback_transactions_2026_08, loyalty.t_cashback_transactions_2026_08]
domain: marketing
status: active
owner: wujiang.ding
...
# Cashback reward transactions via Airdrop M2U API - 2026-08 (t_cashback_transactions_2026_08)

## 用途
物理表 `loyalty.t_cashback_transactions_2026_08`,主键 `id`。Cashback reward transactions via Airdrop M2U API - 2026-08。业务语义细节**待补**(表结构来自 DDL)。
