---
id: tbl_loyalty_t_custom_effects_2026_12
object_type: Table
name: Custom effects from Talon.One - orchestration layer for reward processing - 2026-12 (t_custom_effects_2026_12)
aliases: [t_custom_effects_2026_12, loyalty.t_custom_effects_2026_12]
domain: marketing
status: active
owner: wujiang.ding
...
# Custom effects from Talon.One - orchestration layer for reward processing - 2026-12 (t_custom_effects_2026_12)

## 用途
物理表 `loyalty.t_custom_effects_2026_12`,主键 `id`。Custom effects from Talon.One - orchestration layer for reward processing - 2026-12。业务语义细节**待补**(表结构来自 DDL)。
