---
id: tbl_loyalty_t_cashback_transactions_2026_05
object_type: Table
name: Cashback reward transactions via Airdrop M2U API - 2026-05 (t_cashback_transactions_2026_05)
aliases: [t_cashback_transactions_2026_05, loyalty.t_cashback_transactions_2026_05]
domain: marketing
status: active
owner: wujiang.ding
...
# Cashback reward transactions via Airdrop M2U API - 2026-05 (t_cashback_transactions_2026_05)

## 用途
物理表 `loyalty.t_cashback_transactions_2026_05`,主键 `id`。Cashback reward transactions via Airdrop M2U API - 2026-05。业务语义细节**待补**(表结构来自 DDL)。
