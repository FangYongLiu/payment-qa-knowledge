...
## 用途
分公司。属 merchant 库,由 [[svc_merchant]] 读写。
...
| 列 | 类型 | 约束 | 说明 |
| --- | --- | --- | --- |
| `id` | bigint | PK / AUTO_INC | branch id |
| `group_id` | bigint | NOT NULL | 集团ID |
| `name` | varchar(128) | NOT NULL | 分公司名称 |
...
- 主键:(`id`)
- 唯一约束:
  - `uidx_gid_bname` 唯一 (group_id, name)
- 索引:无(或见 DDL)
