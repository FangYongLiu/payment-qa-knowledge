...
4. 激活码被设备扫码激活后,绑定关系写入 [[tbl_merchant_device]],设备硬件信息登记到 [[tbl_hardware_info]];后续该设备产生的交易落入 Fiserv 订单族表(如 [[tbl_fiserv_sale_order]])。
...
- [[tbl_hardware_info]]:激活流程完成后登记设备硬件信息。
