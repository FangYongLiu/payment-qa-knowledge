---
id: tbl_aml_t_recover_funds_order
object_type: Table
domain: compliance
status: active
owner: dewen.li
...
- aml
- aml
- t_recover_funds_order
subdomain: aml
module: null
sensitivity: normal
name: 追回资金订单表(t_recover_funds_order)
aliases:
- t_recover_funds_order
related_services:
- svc_aml
related_scenarios: []
---
# 追回资金订单表(t_recover_funds_order)

## 用途
追回资金订单表。属 aml 库,由 [[svc_aml]] 读写。
...
| 列 | 类型 | 约束 | 说明 |
| --- | --- | --- | --- |
| `recover_order_no` | bigint | PK / NOT NULL | 追回资金订单号 |
...
| `relative_payment_order` | bigint | NOT NULL | 关联的支付订单(拒付的那笔) |
