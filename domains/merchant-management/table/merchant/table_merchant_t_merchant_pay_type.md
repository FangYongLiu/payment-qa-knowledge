---
id: tbl_merchant_t_merchant_pay_type
object_type: Table
...
module: null
sensitivity: normal
name: 商户支付渠道配置(t_merchant_pay_type)
aliases:
- t_merchant_pay_type
related_services:
- svc_merchant
related_scenarios: []
---
# 商户支付渠道配置(t_merchant_pay_type)

## 用途
商户支付渠道配置。属 merchant 库,由 [[svc_merchant]] 读写。
...
| `pay_type_id` | bigint | NOT NULL | 名称 |
...
- 主键:(`id`)
- 唯一约束:
  - `UID_MID_CODE` 唯一 (merchant_mid, pay_type_id)
- 索引:无(或见 DDL)
