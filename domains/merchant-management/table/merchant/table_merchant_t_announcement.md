---
id: tbl_merchant_t_announcement
object_type: Table
...
## 用途
公告。属 merchant 库,由 [[svc_merchant]] 读写。
...
| `status` | varchar(32) | NOT NULL | 状态 ON, OFF |
| `scene` | varchar(32) | NOT NULL | 场景 |
| `message` | varchar(2000) | NOT NULL | 消息体 |
