---
id: tbl_remittance_t_quotation_strategy
object_type: Table
domain: remittance
status: active
owner: lei.pan
...
- remittance
- remittance
- t_quotation_strategy
subdomain: remittance
module: null
sensitivity: normal
name: 汇率策略(t_quotation_strategy)
aliases:
- t_quotation_strategy
related_services:
- svc_remittance
related_scenarios: []
---
# 汇率策略(t_quotation_strategy)

## 用途
汇率策略。属 remittance 库,由 [[svc_remittance]] 读写。
...
| 列 | 类型 | 约束 | 说明 |
| --- | --- | --- | --- |
| `quotation_strategy_id` | int | PK / AUTO_INC | 主键 |
| `inst_code` | varchar(25) |  | 机构code |
...
| `fixed_percent` | decimal(15,8) |  | 固定百分比 |
| `fixed_amount` | decimal(15,4) |  | 固定金额 |
