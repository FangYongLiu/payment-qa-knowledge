---
id: tbl_remittance_t_exchange_rate_history
object_type: Table
domain: remittance
status: active
owner: lei.pan
...
- remittance
- remittance
- t_exchange_rate_history
subdomain: remittance
module: null
sensitivity: normal
name: 汇率历史记录表(t_exchange_rate_history)
aliases:
- t_exchange_rate_history
related_services:
- svc_remittance
related_scenarios: []
---
# 汇率历史记录表(t_exchange_rate_history)

## 用途
汇率历史记录表。属 remittance 库,由 [[svc_remittance]] 读写。
...
| `previous_rate` | decimal(15,8) | NOT NULL | 上次汇率 |
| `current_rate` | decimal(15,8) | NOT NULL | 当前汇率 |
| `rate_date` | datetime | NOT NULL | 汇率日期 |
| `rate_time` | timestamp | NOT NULL | 汇率更新时间 |
