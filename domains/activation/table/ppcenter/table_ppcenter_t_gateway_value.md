---
id: tbl_ppcenter_t_gateway_value
object_type: Table
domain: activation
status: active
owner: xiaoyan.zhou
...
related_scenarios: []
---
# 商户接口组配置值(t_gateway_value)

## 用途
商户接口组配置值。属 ppcenter 库,由 [[svc_ppcenter]] 读写。
...
| `gateway_group_code` | varchar(64) | NOT NULL | 接口组code |
