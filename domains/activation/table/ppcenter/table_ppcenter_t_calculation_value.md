---
id: tbl_ppcenter_t_calculation_value
object_type: Table
domain: activation
status: active
owner: xiaoyan.zhou
...
module: null
sensitivity: normal
name: 算费配置值(t_calculation_value)
aliases:
- t_calculation_value
related_services:
- svc_ppcenter
related_scenarios: []
---
# 算费配置值(t_calculation_value)

## 用途
算费配置值。属 ppcenter 库,由 [[svc_ppcenter]] 读写。
...
| `party_role` | varchar(12) | NOT NULL | 收费角色 |
