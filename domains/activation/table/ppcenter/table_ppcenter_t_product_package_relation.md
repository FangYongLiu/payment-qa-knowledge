---
id: tbl_ppcenter_t_product_package_relation
object_type: Table
domain: activation
status: active
owner: xiaoyan.zhou
...
- ppcenter
- pricing
- t_product_package_relation
subdomain: pricing
module: null
sensitivity: normal
name: 产品集关系(t_product_package_relation)
aliases:
- t_product_package_relation
related_services:
- svc_ppcenter
related_scenarios: []
---
# 产品集关系(t_product_package_relation)

## 用途
产品集关系。属 ppcenter 库,由 [[svc_ppcenter]] 读写。
...
| `package_id` | int(12) | NOT NULL | 产品集id |
