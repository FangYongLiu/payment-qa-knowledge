---
id: tbl_ppcenter_t_product_audit_log
object_type: Table
domain: activation
status: active
owner: xiaoyan.zhou
...
module: null
sensitivity: normal
name: 产品审核日志(t_product_audit_log)
aliases:
- t_product_audit_log
related_services:
- svc_ppcenter
related_scenarios: []
---
# 产品审核日志(t_product_audit_log)

## 用途
产品审核日志。属 ppcenter 库,由 [[svc_ppcenter]] 读写。
